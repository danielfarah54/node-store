...
exports.refreshToken = async (req, res, next) => {
    try {
        const oldToken = req.body.token || req.query.token || req.headers['x-access-token']
        const tokenData = await authService.decodeToken(oldToken)

        const customer = await repository.getById(tokenData.id)
